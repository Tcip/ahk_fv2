...
F1::
Gui +AlwaysOnTop
Gui, Add, Text,, Keyboard shortcuts for Farmville 2 on Chrome`n`nQ = Exit the program`nP = Pause the program`n`n1 = Start the clicks.`nPress the hotkey to click on all requests from your friends.
